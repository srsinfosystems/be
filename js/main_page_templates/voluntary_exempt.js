...
var tabfunc = {
	...
	bindEvents:function(trans){
		...
		var msg = global_translationsData.Everycustomerhasanhourbankholdingthenumberofhoursofvoluntaryworkthatthiscustomershouldcarryout+'.<br/>';
		msg += global_translationsData.Hereyoucanaddorresetthehoursinthehourbank+'.<br/>';
		msg += global_translationsData.Changesmadeherewillaffectallorgroupsofcustomersinthesystem+'.<br/>';
		...
		var msg = global_translationsData.Controlswhetheravoluntaryworkmanagershouldbesetforvoluntaryworktasks;
	...
	add_fixed_hours:function(){
		...
		var message = global_translationsData.Thisadds+' '+all_hours_voluntary+' ';
		message+= global_translationsData.numberofhourstothehourbankofeverycustomer +'.';
