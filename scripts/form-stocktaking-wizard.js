        ...
        init: function () {
            ...
            $('#form_wizard_1').bootstrapWizard({
                ...
                onNext: function (tab, navigation, index) {
                    ...
                    $(".send_cancel").hide();
                    //$("#btn_continue").show();  //080 05-07-2016

                    if (current == 1) {
                        $('#form_wizard_1').find('.button-previous').hide();
                        $('#form_wizard_1').find("#btn_continue").hide(); //080 05-07-2016
						...
						$(".selectgroups").each(function(){			
							...
							if(prop2 == true){
								...
								//#080
								var total_customer_ids = $("#total_product_ids_"+id).val(); //#080 28-06-2016
								var total_unselected_customer_ids = $("#final_total_unselected_product_ids_"+id).val(); //#080 28-06-2016
						...
						//#080 29-06-2016 #35208: BE > Inventory Module > create mockup start
						var StocktakingTypeProductGroup = $("#StocktakingTypeProductGroup").prop('checked');
							if(StocktakingTypeProductGroup == true){
							if(total_recipients_count <= 0){
								showAlertMessage("Please select product groups",'error');
								return false;
							}
						}
						//#080 29-06-2016 #35208: BE > Inventory Module > create mockup end		
						...
						*/					
                        ...
                        $('#form_wizard_1').find('.button-previous').show();
                         $('#form_wizard_1').find("#btn_continue_new").hide(); //080 05-07-2016
                   }
                    ...
                    if (current >= total) {
                        ...
                        //$('#form_wizard_1').find('.button-next').show(); //080 05-07-2016
                    ...
                    if (current == 2) {
						$("#manual_table").html('<tr style="display:none" class="odd gradeX" id="sale_product_search"><td><input type="hidden" id="line_key" value="0"></td></tr>');
						var StocktakingTypeManual = $("#StocktakingTypeManual").prop('checked'); //	##080 12-07-2016 #35307: BE > Inventory Module > Step 3
						if(StocktakingTypeManual == true){
							add_new_product_line();	
							$("#export_product_list").hide();//	##080 12-07-2016 #35307: BE > Inventory Module > Step 3
						}
						else{
							$("#export_product_list").show();//	##080 12-07-2016 #35307: BE > Inventory Module > Step 3
						}						
					}	 
                ...
                onPrevious: function (tab, navigation, index) {
                    ...
                    for (var i = 0; i < index; i++) {
                     ...
                     $("#id_send_orig_message").hide();
                     $(".send_cancel").hide();
                     $("#btn_continue").hide(); //080 05-07-2016
                     $("#btn_continue_new").show(); //080 05-07-2016
