...
function new_custom_main_page2(urrl,menu_id,sub_menu_id,main_page_template_id,custom_data='',process='y'){
	...
	var url1 = $('#HOST_URL').val()+"app/webroot/js/main_page_templates/"+main_page_template_id+"/"+main_page_template_id+".html";
	var url2 = $('#HOST_URL').val()+"app/webroot/js/main_page_templates/"+main_page_template_id+"/"+main_page_template_id+".js";
