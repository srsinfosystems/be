...
(function (factory) {
    ...
    $.widget('blueimp.fileupload', $.blueimp.fileupload, {
        ...
        _deleteHandler: function (e) {			
			//#044 27-Jan-2016 0033438: BE > Two feature requests, minbefaring.no > 01
			var pathname = window.location.pathname; 			
			var pathname_indexof = pathname.indexOf("mass_communication_list");			
			if(pathname_indexof == '-1'){				
				e.preventDefault();
				var button = $(e.currentTarget);
				...
				e.preventDefault();
				var button = $(e.currentTarget);				
				button.closest('.template-download').attr('id', 'del_this');
				chk_confirm_del(); 					
			}           
        },
        _deleteBrandlogoHandler: function (e) {			
			//#044 27-Jan-2016 0033438: BE > Two feature requests, minbefaring.no > 01
			e.preventDefault();
			var button = $(e.currentTarget);				
			deleteBrandLogo();         
        },
        _deleteSalesBrandlogoHandler: function (e) {			
			//#044 27-Jan-2016 0033438: BE > Two feature requests, minbefaring.no > 01
			e.preventDefault();
			var button = $(e.currentTarget);				
			deleteSalesBrandLogo();         
        },
        ...
        _initEventHandlers: function () {
            ...
            this._on(this.options.filesContainer, {
                ...
                'click .delete_brands_logo button': this._deleteBrandlogoHandler,
                'click .delete_sales_brand_logo button': this._deleteSalesBrandlogoHandler
            });
