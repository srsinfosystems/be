...
(function(a) {
    ...
    a.extend(a.validator, {
        ...
        methods: {
            ...
            number: function(c, b) {
				//#044 19-Feb-2016 0033781: BE > mass invoicing feature start
				var pathname = window.location.pathname; 	
				var mass_invoice_exist = pathname.search("mass_invoice"); 
				if(mass_invoice_exist > 0){
					return true;
				}
				//#044 19-Feb-2016 0033781: BE > mass invoicing feature end
