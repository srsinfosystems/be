...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["FullCalendarNew"] = factory(require("moment"), require("jquery"));
	else
		root["FullCalendarNew"] = factory(root["moment"], root["jQuery"]);
...
/* FullCalendarNew-specific DOM Utilities
----------------------------------------------------------------------------------------------------------------------*/
...
momentProperties.push('_fullCalendarNew');
...
function makeMoment(args, parseAsUTC, parseZone) {
    ...
    mom._fullCalendarNew = true; // flag for extended functionality
    return mom;
}
// Week Number
// -------------------------------------------------------------------------------------------------
...
newMomentProto.week = newMomentProto.weeks = function (input) {
    var weekCalc = this._locale._fullCalendarNew_weekCalc;
...
newMomentProto.time = function (time) {
    // Fallback to the original method (if there is one) if this moment wasn't created via FullCalendarNew.
    // `time` is a generic enough method name where this precaution is necessary to avoid collisions w/ other plugins.
    if (!this._fullCalendarNew) {
...
// When introducing internal API incompatibilities (where fullcalendarNew plugins would break),
...
function datepickerLocale(localeCode, dpLocaleCode, dpOptions) {
    // get the FullCalendarNew internal option hash for this locale. create if necessary
    ...
    if (jqDatePicker) {
        ...
        // FullCalendarNew and MomentJS use locale codes like "pt-br" but Datepicker
...
// Sets FullCalendarNew-specific translations. Will set the locales as the global default.
function locale(localeCode, newFcOptions) {
    ...
    // set it as the default locale for FullCalendarNew
...
moment_ext_1.newMomentProto.format = function () {
    if (this._fullCalendarNew && arguments[0]) {
...
var DayGrid = /** @class */ (function (_super) {
    ...
    DayGrid.prototype.renderNumberCellHtml = function (date) {
        ...
        if (this.cellWeekNumbersVisible) {
            ...
            if (date._locale._fullCalendarNew_weekCalc === 'ISO') {
    ...
    Calendar.prototype.initMomentInternals = function () {
        ...
        this.optionsManager.watch('buildingMomentLocale', [
            ...
            if (weekNumberCalculation === 'ISO' ||
                ...
                localeData._fullCalendarNew_weekCalc = weekNumberCalculation; // moment-ext will know what to do with it
            }
...
----------------------------------------------------------------------------------------------------------------------*/
// Require all HTML5 data-* attributes used by FullCalendarNew to have this prefix.
...
$.fullCalendarNew = exportHooks;
$.fn.fullCalendarNew = function (options) {
    var args = Array.prototype.slice.call(arguments, 1); // for a possible method call
    var res = this; // what this function will return (this jQuery object by default)
    this.each(function (i, _element) {
        var element = $(_element);
        var calendar = element.data('fullCalendarNew'); // get the existing calendar object (if any)
        ...
        if (typeof options === 'string') {
            if (options === 'getCalendar') {
                ...
                if (calendar) {
                    calendar.destroy();
                    element.removeData('fullCalendarNew');
                }
            }
            else if (!calendar) {
                util_1.warn('Attempting to call a FullCalendarNew method on an element with no calendar.');
            }
                ...
                util_1.warn("'" + options + "' is an unknown FullCalendarNew method.");
            }
        }
        else if (!calendar) {
            calendar = new Calendar_1.default(element, options);
            element.data('fullCalendarNew', calendar);
            calendar.render();
        }
    });
    return res;
