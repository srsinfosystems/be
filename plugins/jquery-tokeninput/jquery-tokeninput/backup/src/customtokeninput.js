 ...
 * 
 * 20-02-2017 by  #080 SUMIT
 * this is the altered verion of original file,
 * specially designed for communication module.  
 */
...
$.customTokenList = function (input, url_or_data, settings) {
    ...
    function run_search(query) {
        ...
        if(cached_results) {
            populate_dropdown(query, cached_results.response.response);
        } else {
