!function($, wysi) {
    ...
    var tpl = {
        "placeholders": function(locale, options) {
            ...
            if($("#placeholder-toolbar").length) {
                return $("#placeholder-toolbar").html();
            }
            return "";
        },
        ...
        "link": function(locale, options) {
            ...
            return "<li>" +
              "<div class='bootstrap-wysihtml5-insert-link-modal modal hide fade'>" +
                ...
                /********* #024 20-01-2014 #25965, BookingEngine > Insert link in editor ********/
                  "<input type='text' value='http://' class='bootstrap-wysihtml5-insert-link-url m-wrap large'>" +
				/********* #024 20-01-2014 #25965, BookingEngine > Insert link in editor ********/		
